...
using VW.Forum.Data;
using VW.Forum.Web.Extensions;
using VW.Forum.Web.Models.AccountViewModels;
...
namespace VW.Forum.Web.Controllers
{
	...
	public class AccountController : Controller
	{
		...
		{
			bool administratorRoleExist = await _roleManager.RoleExistsAsync("Administrator");
			...
			if (ModelState.IsValid)
			{
				var user = new Entities.User { UserName = model.UserName, Email = model.Email };
				...
				if (result.Succeeded)
				{
					...
					if (user.Email == "martinatanasov0204@gmail.com")
					{
		...
		public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
		{
			if (ModelState.IsValid)
			{
				...
				var user = new Entities.User { UserName = model.Email, Email = model.Email };
